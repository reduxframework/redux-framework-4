...
if ( ! class_exists( 'Redux_Import_Export', false ) ) {
	...
	class Redux_Import_Export extends Redux_Field {
		...
		public function render() {
			...
			<p>
				<button data-secret="<?php echo esc_attr( $secret ); ?>" id="redux-export-code-copy" class="button-secondary" data-copy="<?php esc_attr_e( 'Copy Data', 'redux-framework' ); ?>" data-copied="<?php esc_attr_e( 'Data Copied!', 'redux-framework' ); ?>">
