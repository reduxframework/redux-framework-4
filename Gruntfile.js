...
module.exports = function( grunt ) {
    ...
    grunt.initConfig(
        {
            ...
            sass: {
                ...
                colors: {
                    ...
                    files: [{
                        expand: true,                   // Enable dynamic expansion.
                        cwd: 'ReduxCore/assets/css/colors',    // Src matches are relative to this path.
                        src: ['**/*.scss'],             // Actual pattern(s) to match.
                        dest: 'ReduxCore/assets/css/colors',   // Destination path prefix.
                        ext: '.css'                     // Dest filepaths will have this extension.
                    }]
                },
    ...
    grunt.registerTask( "compileSCSS", ["sass:admin", "sass:fields", "sass:extensions", "sass:vendor", "sass:welcome", "sass:colors"] );
    grunt.registerTask(
        'compileJS',
