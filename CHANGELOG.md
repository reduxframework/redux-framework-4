...
* Added:    Iris color pickers in all fields now support alpha channel when 'color_alpha' argument is set at the field level.
* Added:    Typography now has 'margin-top' and 'margin-bottom' arguments.
...
* Added:    New global arg 'flyout_submenus'.  When set, all subsections in the options panel (and metaboxes) will flyout when the mouse hovers over the parent menu item.
