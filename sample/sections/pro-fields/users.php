...
Redux_Users::set_profile(
	...
	array(
		...
		'sections' => array(
			array(
				...
				'fields' => array(
					array(
						'id'    => 'user-text',
						'type'  => 'text',
						'title' => esc_html__( 'Input 1', 'your-domain-here' ),
					),
					array(
						'id'       => 'user-text-2',
						'type'     => 'text',
						'required' => array( 'user-text', '=', 'two' ),
						'title'    => esc_html__( 'Input 2', 'your-domain-here' ),
					),
					array(
						'id'    => 'user-text-3',
						'type'  => 'text',
						'title' => esc_html__( 'Input 3', 'your-domain-here' ),
					),
					array(
						'id'       => 'webFonts',
						'type'     => 'media',
						'title'    => esc_html__( 'Web Fonts', 'your-domain-here' ),
						'compiler' => 'true',
						'mode'     => false,
					...
					array(
						...
						'type'     => 'section',
						'title'    => esc_html__( 'Media Options', 'your-domain-here' ),
						'subtitle' => esc_html__( 'With the "section" field you can create indent option sections.' ),
						'indent'   => true,
					),
					array(
						'id'       => 'mediaurl',
					...
					array(
						'id'       => 'gallery',
						'type'     => 'gallery',
						'title'    => esc_html__( 'Add/Edit Gallery', 'so-panels' ),
					...
					array(
						'id'      => 'slider1bDOVY23',
						'type'    => 'slider',
						'title'   => esc_html__( 'JQuery UI Slider Example 1', 'your-domain-here' ),
						'desc'    => esc_html__( 'JQuery UI slider description. Min: 1, max: 500, step: 3, default value: 45', 'your-domain-here' ),
						'default' => '46',
						'min'     => '1',
						'step'    => '3',
						'max'     => '500',
					...
					array(
						'id'      => 'slider2bc',
						'type'    => 'slider',
						'title'   => esc_html__( 'JQuery UI Slider Example 2 w/ Steps (5)', 'your-domain-here' ),
						'desc'    => esc_html__( 'JQuery UI slider description. Min: 0, max: 300, step: 5, default value: 75', 'your-domain-here' ),
						'default' => '0',
						'min'     => '0',
						'step'    => '5',
						'max'     => '300',
			...
			array(
				'title'  => esc_html__( 'Home Layout', 'your-domain-here' ),
				'icon'   => 'el-icon-home',
				'fields' => array(
					array(
						'id'       => 'homepage_blocks',
