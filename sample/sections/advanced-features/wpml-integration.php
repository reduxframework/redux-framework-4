...
Redux::set_section(
	...
	array(
		...
		'desc'       => esc_html__( 'These fields can be fully translated by WPML (WordPress Multi-Language). This serves as an example for you to implement. For extra details look at our <a href="https://devs.redux.io/guides/advanced/wpml-integration.html" target="_blank" >WPML Implementation</a> documentation.', 'your-textdomain-here' ),
		'subsection' => true,
		'fields'     => array(
			array(
				'id'    => 'wpml-text',
