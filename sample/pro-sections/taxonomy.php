...
Redux_Taxonomy::set_args( $opt_name, array(
	'taxonomy_priority' => 50,
) );

Redux_Taxonomy::set_term( $opt_name, array(
	'id'             => 'demo-taxonomy',
	...
	// Removes the Redux styles. Redux styles defaultly removed from the add {TERM} pages.
	// 'style'          => 'wp',
		...
		array(
			...
			'fields' => array(
				array(
					...
					'add_visibility' => true,
					'title'          => __( 'Dovy Input1', 'redux-framework-demo' ),
				),
				...
				array(
					...
					'title'          => __( 'Dovy Input2', 'redux-framework-demo' ),
				),
				array(
					'id'             => 'opt-button-set',
					'type'           => 'button_set',
