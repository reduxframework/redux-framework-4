...
class Redux_Descriptor_Field {
	...
	/**
	 * Redux_Descriptor_Field constructor.
	 *
	...
	public function __construct( $field ) {
		...
		$this->field_type = strtolower( $this->reflection_class->getShortName() );
	 ...
	 * @param null   $default Field default value.
	 *
