...
if ( ! class_exists( 'Redux_Taxonomy' ) ) {
	...
	class Redux_Taxonomy {
		 ...
		 */
		public static function process_sections_array( $opt_name = '', $term_id = '', $sections = array() ) {
		 ...
		 */
		public static function set_term( $opt_name = '', $term = array() ) {
			self::check_opt_name( $opt_name );
		 ...
		 */
		public static function set_terms( $opt_name = '', $terms = array() ) {
