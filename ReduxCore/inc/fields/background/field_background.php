    ...
    class ReduxFramework_background extends Redux_Field {
        ...
        public function render() {
            ...
            if ( $this->field['background-color'] === true ) {
                ...
                if (!$use_gradient) {
                    ...
                    echo '<input
                                ...
                                data-alpha="' . $this->field['color_alpha'] . '"
                                />';
            ...
            if ( $this->field['background-image'] === true ) {
                ...
                echo '<img class="redux-option-image" id="image_' . esc_attr($this->value['media']['id']) . '" src="' . esc_url($this->value['media']['thumbnail']) . '" alt="" target="_blank" rel="external" />';
                echo '</a>';
                echo '</div>';
