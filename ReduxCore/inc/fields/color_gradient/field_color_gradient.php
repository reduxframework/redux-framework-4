    ...
    if ( ! class_exists( 'ReduxFramework_color_gradient' ) ) {
        ...
        class ReduxFramework_color_gradient extends Redux_Field {
            ...
            public function enqueue() {
                if ( ! wp_style_is( 'redux-nouislider-css' ) || ( isset( $this->field['gradient-reach'] ) && $this->field['gradient-reach'] ) || ( isset( $this->field['gradient-angle'] ) && $this->field['gradient-angle'] ) ) {
                    wp_enqueue_style(
                ...
                if ( isset( $this->field['gradient-type'] ) && ! empty( $this->field['gradient-type'] ) ) {
