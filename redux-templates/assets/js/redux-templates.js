...
const MultipleItem = props => {
  ...
  }), Object(_redux_templates_stores_dependencyHelper__WEBPACK_IMPORTED_MODULE_1__["requiresPro"])(data) && wp.element.createElement("span", {
    className: "redux-templates-pro-badge"
  }, __('Premium', redux_templates.i18n)), !Object(_redux_templates_stores_dependencyHelper__WEBPACK_IMPORTED_MODULE_1__["requiresPro"])(data) && Object(_redux_templates_stores_dependencyHelper__WEBPACK_IMPORTED_MODULE_1__["requiresInstall"])(data) && wp.element.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_0__["Tooltip"], {
...
function DependencyFilter(props) {
  ...
  const setDependencyFilters = props.setDependencyFilters; // Give the selected category(activeCategory) label className as "active"
  ...
  return wp.element.createElement(Fragment, null, !loading && wholePlugins && wp.element.createElement("div", {
    ...
    href: "#",
    onClick: () => setDependencyFilters(Object(_stores_helper__WEBPACK_IMPORTED_MODULE_3__["getInstalledDependencies"])(dependencyFilters))
    ...
    href: "#",
    onClick: () => setDependencyFilters(Object(_stores_helper__WEBPACK_IMPORTED_MODULE_3__["getDefaultDependencies"])(dependencyFilters))
  }, wp.element.createElement("i", {
...
function DependencyFilterRow(props) {
  ...
  return wp.element.createElement("li", {
    ...
    text: __('Plugin not Installed', redux_templates.i18n)
  }, wp.element.createElement("i", {
...
function Sidebar(props) {
  ...
  return wp.element.createElement("div", {
    ...
    "data-tut": "tour__filtering"
  }, hasSidebar() && wp.element.createElement("div", null, wp.element.createElement(_priceFilter__WEBPACK_IMPORTED_MODULE_1__["default"], null), wp.element.createElement(_categoryFilter__WEBPACK_IMPORTED_MODULE_2__["default"], null), wp.element.createElement(_dependencyFilter__WEBPACK_IMPORTED_MODULE_3__["default"], null)));
}
...
function PriceFilter(props) {
  ...
  }, __('All', redux_templates.i18n))), wp.element.createElement("div", null, wp.element.createElement("button", {
    onClick: () => setActivePriceFilter('free'),
    className: getClassnames('free'),
    disabled: noStatistics('free')
  }, __('Free', redux_templates.i18n))), wp.element.createElement("div", null, wp.element.createElement("button", {
...
function ExportContentMenuItem({
  ...
  }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])('Export full page', redux_templates.i18n)));
}
...
const getInstalledDependencies = dependencies => {
  const unSupportedPlugins = Object.keys(redux_templates.supported_plugins).filter(key => isPluginProActivated(key) === false);
  return Object.keys(dependencies).filter(key => key !== 'none').reduce((acc, cur) => {
    // special handling for pro plugin not activated.
    let value = true;
...
const reducer = (state = initialState, action) => {
  switch (action.type) {
    case 'SET_LIBRARY':
      ...
      const dependencies = Object(_helper__WEBPACK_IMPORTED_MODULE_0__["getDefaultDependencies"])(action.library.dependencies);
      let parsedSection = Object(_helper__WEBPACK_IMPORTED_MODULE_0__["parseSectionData"])(action.library.sections);
      let parsedPage = Object(_helper__WEBPACK_IMPORTED_MODULE_0__["parsePageData"])(action.library.pages);
      let parsedCollection = Object(_helper__WEBPACK_IMPORTED_MODULE_0__["parseCollectionData"])(action.library);
...
function ToolbarLibraryButton(props) {
  return wp.element.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_0__["Tooltip"], {
    text: `Block Templates for ${redux_templates.theme_name}`
