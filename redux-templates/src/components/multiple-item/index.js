    ...
    return (
        <div className="redux-templates-multiple-template-box">
            <div className="multiple-template-view" onClick={ () => onSelectCollection( ID ) } >
                <div className="redux-templates-default-template-image"><img alt={__('Default Template', redux_templates.i18n)} src={backgroundImage(image)} srcSet={backgroundImage(image)+ ' 2x'}/>
