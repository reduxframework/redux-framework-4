	                ...
	                <>
		                <ButtonGroup style={{float:'right'}}>
			                ...
			                <Tooltip text={__('Find templates that only contain blocks from the selected plugins.', redux_templates.i18n)} position="top right">
				                <Button isSmall isSecondary={dependencyFilterRule === false} isPrimary={dependencyFilterRule} isPressed={dependencyFilterRule} onClick={() => setDependencyFilterRule(true)} disabled={activeItemType === 'collection'}>{__('Only', redux_templates.i18n)}</Button>
			                </Tooltip>
		                </ButtonGroup>
