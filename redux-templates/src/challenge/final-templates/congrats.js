...
function ChallengeCongrats(props) {
    ...
    return (
        <div className="reduxtemplates-modal-overlay">
            <div className="reduxtemplates-modal-wrapper challenge-popup-wrapper">
                <div class="challenge-popup-header challenge-popup-header-congrats" 
                    style={{backgroundImage: `url(${reduxtemplates.plugin + 'assets/img/popup-congrats.png'})`}}>
                    <a className="challenge-popup-close" onClick={closeModal}>
                        <i class="fa fa-times-circle fa-lg"></i>
                    </a>
                </div>
                <div class="challenge-popup-content">
                    <h3>{__( 'Congrats, you did it!', reduxtemplates.i18n )}</h3>
                    <p>
                    ...
                    <a href="https://wordpress.org/support/plugin/reduxtemplates/reviews/?filter=5#new-post" class="challenge-popup-btn challenge-popup-rate-btn" target="_blank" rel="noopener">
                        {__( 'Rate ReduxTemplates on Wordpress.org', reduxtemplates.i18n ) }
...
export default compose([
    withDispatch((dispatch) => {
        const { setChallengeStep, setChallengeFinalStatus, setChallengeOpen } = dispatch('reduxtemplates/sectionslist');
        return {
            setChallengeStep,
            setChallengeFinalStatus,
            setChallengeOpen
